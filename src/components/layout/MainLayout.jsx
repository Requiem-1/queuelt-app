    ...
    <AnimatePresence mode="wait">
      {isAdminRoute ? (
        <motion.div
          ...
          className="relative flex h-screen overflow-hidden w-full bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors duration-200"
        >
          <AmbientBackground />
          <OfflineBanner />
          <Sidebar
        ...
        <motion.div
          ...
          exit={{ opacity: 0 }}
          transition={{ duration: 0.2, ease: 'easeOut' }}
          className="relative min-h-screen flex flex-col bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors duration-200 overflow-x-hidden"
        >
          <AmbientBackground />
          <OfflineBanner />
          <Navbar />
